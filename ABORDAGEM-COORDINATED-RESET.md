> ## Documento de contexto — abordagem não adotada
>
> Este arquivo descreve o **Coordinated Reset**, uma segunda abordagem que
> chegou a ser implementada e testada neste projeto, mas **não é a que está no
> firmware atual**. O ParkinSense usa **contra-estímulo** — veja o
> [README.md](README.md).
>
> Está guardado aqui porque é uma direção de pesquisa real, com literatura por
> trás, e pode ser retomada no futuro.
>
> **O código funcional do CR está preservado no repositório:**
>
> ```bash
> git checkout abordagem-coordinated-reset
> ```
>
> A branch `correcoes-firmware` aponta para o mesmo trabalho. Nada foi perdido.

---

# ParkinSense — abordagem Coordinated Reset
